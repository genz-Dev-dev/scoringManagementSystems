...
@Component( {
  ...
  styleUrl: './upload-score.component.scss',
} )
export class UploadScoreComponent implements OnInit
{
  ...
  constructor(private router: Router, private departmentClassService: DepartmentService, private studentService: StudentService, private fb: FormBuilder )
  {
